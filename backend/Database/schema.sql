...
CREATE TABLE Products (
    ...
    CategoryID   INT,
    SupplierID   INT,
    -- [PROD] Guard against negative prices
...
CREATE TABLE Orders (
    ...
    -- [PROD] Only known statuses allowed
    Status        VARCHAR(20)   DEFAULT 'Pending'
                                CHECK (Status IN (
                                    'Pending', 'Confirmed', 'Shipped',
                                    'Delivered', 'Cancelled', 'Returned'
                                )),
    -- [PROD] Discount and tax stored per order
    ...
    -- [PROD] TotalAmount persisted but kept for fast reads;
    --         keep in sync via app layer or replace with a view.
...
CREATE TABLE OrderItems (
    ...
    SubTotal    AS (Quantity * UnitPrice),   -- computed, always consistent
...
CREATE TABLE Payments (
    ...
    Amount        DECIMAL(10,2),
    -- [PROD] Only known payment statuses allowed
...
CREATE TABLE InventoryTransactions (
    ...
    ProductID       INT,
    WarehouseID     INT,
    -- [PROD] Quantity is required; sign follows TransactionType
    Quantity        INT      NOT NULL,
    -- [PROD] Only known transaction types allowed
    TransactionType VARCHAR(20) CHECK (TransactionType IN (
...
-- ============================================================
--  [PROD] Trigger: sync Inventory when a Return is recorded
-- ============================================================
GO
...
BEGIN
    ...
    -- Restore returned quantity back into Inventory
    UPDATE inv
    SET
    ...
    -- Log the movement in InventoryTransactions
...
-- ============================================================
--  [PROD] Indexes — bare minimum for query performance
-- ============================================================

-- Orders: most common filter columns
CREATE INDEX IX_Orders_CustomerID  ON Orders(CustomerID);
CREATE INDEX IX_Orders_Status      ON Orders(Status);
CREATE INDEX IX_Orders_OrderDate   ON Orders(OrderDate);

-- OrderItems: join path from Orders
